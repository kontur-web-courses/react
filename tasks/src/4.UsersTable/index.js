...
/**
    ...
    Функционал работает, но при любом действии пользователя происходит множество лишних операций в React.
    ...
    1. В начале происходят все 6 событий и это нормально:
    ...
    5. При сохранении после изменения другого поля : UserTable render
    ...
    - Изменение setState в компоненте приводит к его перерисовке. Часто вместе с детьми.
      Но дочеркий PureComponent 
    - Помни про PureComponent: он перерисовывается только если одно из свойств поменялось.
